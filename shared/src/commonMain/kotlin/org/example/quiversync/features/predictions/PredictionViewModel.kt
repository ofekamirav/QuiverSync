...
private fun createMockPrediction(): WeeklyPrediction {
    ...
    val forecasts = listOf(
        DailyForecast("2025-06-21", 0.63, 3.37, 248.61, 5.89, 294.67),
        DailyForecast("2025-06-22", 0.77, 3.54, 227.29, 6.33, 293.84),
        DailyForecast("2025-06-23", 1.04, 3.06, 226.87, 7.34, 294.53),
        DailyForecast("2025-06-24", 0.81, 2.83, 229.92, 7.34, 298.98),
        DailyForecast("2025-06-25", 0.58, 2.84, 226.47, 6.33, 298.79),
        DailyForecast("2025-06-26", 0.47, 3.06, 245.2, 6.0, 297.6)
    )
